...
rain.anim.citizen_female = {
	...
	glide = ACT_GLIDE,
	vehicle = rain.anim.citizen_male.vehicle
}
rain.anim.metrocop = {
	normal = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE, ACT_IDLE_ANGRY_SMG1},
...
function rain.anim.setModelClass(model, class)
	if (!rain.anim[class]) then
...
function rain.anim.getModelClass(model)
...
rain.anim.setModelClass("models/police.mdl", "metrocop")
rain.anim.setModelClass("models/combine_super_soldier.mdl", "overwatch")
rain.anim.setModelClass("models/combine_soldier_prisonGuard.mdl", "overwatch")
rain.anim.setModelClass("models/combine_soldier.mdl", "overwatch")
rain.anim.setModelClass("models/vortigaunt.mdl", "vort")
rain.anim.setModelClass("models/vortigaunt_blue.mdl", "vort")
rain.anim.setModelClass("models/vortigaunt_doctor.mdl", "vort")
rain.anim.setModelClass("models/vortigaunt_slave.mdl", "vort")
