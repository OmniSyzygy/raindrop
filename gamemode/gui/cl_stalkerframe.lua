...
function PANEL:Init()
	...
	for i = 0, 1 do 
		self.WeaponPanel[i + 1] = vgui.Create("RD_StalkerItemHolder", self)
	...
	for i = 0, 1 do
		self.GearPanel[i + 1] = vgui.Create("RD_StalkerItemHolder", self)
	...
	self.ArtifactDetectorPanel = vgui.Create("RD_StalkerItemHolder", self)
	...
	for i = 1, 4 do
		self.F[i] = vgui.Create("RD_StalkerItemHolder", self)
	...
	for i = 1, 5 do
		self.ArtifactPanel[i] = vgui.Create("RD_StalkerItemHolder", self)
	...
	for i = 1, 2 do
		self.GearDamage[i] = vgui.Create("RD_StalkerProgressBar", self)
	...
	for i = 3, 4 do
		self.GunDamage[i - 2] = vgui.Create("RD_StalkerProgressBar", self)
	...
	self.HealthProgress = vgui.Create("RD_StalkerProgressBar", self)
	...
	for i = 0, 3 do
		self.DamageProgress = vgui.Create("RD_StalkerProgressBar", self)
	...
	self.CharacterIcon = vgui.Create("RD_StalkerCharIcon", self)
...
function PANEL:Paint(w, h)
	...
	draw.DrawText(LocalPlayer():GetRPName(), "NameFont", 506 + 1, 32 + 1, Color(0,0,0,255), TEXT_ALIGN_LEFT) 
	draw.DrawText(LocalPlayer():GetRPName(), "NameFont", 506, 32, Color(190,175,160,255), TEXT_ALIGN_LEFT) 
